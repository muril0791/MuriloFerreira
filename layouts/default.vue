<template>
  <v-app :dark="darkMode">
    <div class="sticky-container">
      <v-icon class="icon-menu" v-if="$vuetify.breakpoint.xsOnly" @click="drawer = !drawer" color="white" icon="home">mdi-menu</v-icon>
      <v-tabs class="sticky-tabs" v-if="!$vuetify.breakpoint.xsOnly"  v-model="tab" bg-color="green" fixed-tabs>
        ...
        <v-tab value="three" @click="scrollTo('expertise')">Conhecimentos</v-tab>
    ...
    <v-navigation-drawer app v-model="drawer" :temporary="true">
      <v-switch v-model="darkMode" label="Dark Mode" @change="toggleDarkMode"></v-switch>
      <v-list dense>
        <v-list-item-group v-if="$vuetify.breakpoint.xsOnly" v-model="drawerTab">
          <v-list-item @click="navigate('sobre-mim', 'one')">Sobre Mim</v-list-item>
          <v-list-item @click="navigate('project', 'two')">Projetos</v-list-item>
          <v-list-item @click="navigate('expertise', 'three')">Conhecimentos</v-list-item>
          <v-list-item @click="navigate('expirience', 'four')">Experiência</v-list-item>
...
#sobre-mim, #project, #expertise, #expirience, #contact {
